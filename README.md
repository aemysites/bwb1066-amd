...
## Environments
- Preview: https://main--bwb1066-amd--aemysites.aem.page/
- Live: https://main--bwb1066-amd--aemysites.aem.live/
...
1. Open the `bwb1066-amd` directory in your favorite IDE and start coding :)
